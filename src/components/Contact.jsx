    ...
    <div id="contact">
      <div className="container m-top">
        ...
        <div className="row mt-5 px-3 px-md-0">
          <div className="col-md-6 contact">
            ...
            <div>
              ...
              <div className="d-flex gap-2 align-items-center mb-3">
                ...
                <a href="https://www.linkedin.com/in/sriram-kannan-v-11jan2005/">
                  LinkedIn
                </a>
              </div>
            </div>
          ...
          <form
            onSubmit={onSubmit}
            className="col-md-6 d-flex flex-column contact-msg"
          >
            ...
            <button
              type="submit"
              className="contact-btn fw-bold fs-5 text-center align-content-center"
            >
              {result}
            </button>
          </form>
